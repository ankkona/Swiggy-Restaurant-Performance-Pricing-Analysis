...
# Dataset
The dataset contains restaurant-level information including ratings, cost, cuisine, city, food type, and delivery distance.This analysis uses a publicly available for educational and portfolio purposes.
